...
exports.index = function (req, res, next) {
  ...
  // 當所有資料查詢完成時執行 render
  render = function (tags, topics, hot_topics, stars, tops, no_reply_topics, pages) {
  ...
  proxy = EventProxy.create('tags', 'topics', 'hot_topics', 'stars', 'tops', 'no_reply_topics', 'pages', render);
